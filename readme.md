...
| JWT Auth   | ![JWT](https://img.shields.io/badge/JWT-000000?logo=json-web-tokens&logoColor=white)    |
...
```bash
git clone https://github.com/username/e-monev-bengkulu-utara-backend.git
cd e-monev-bengkulu-utara-backend
npm install
```
